...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authentication', '0011_alter_userfollows_unique_together_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='following_user',
            field=models.ManyToManyField(blank=True, related_name='followings', to=settings.AUTH_USER_MODEL, verbose_name='suivre'),
        ),
        migrations.AlterField(
            model_name='user',
            name='follows',
            field=models.ManyToManyField(blank=True, related_name='follow', to=settings.AUTH_USER_MODEL, verbose_name='suivi par'),
        ),
        migrations.AlterField(
            model_name='userfollows',
            name='followed_user',
